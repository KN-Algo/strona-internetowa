...
<head>
    ...
    <title><?php echo htmlspecialchars($translations['title-projects-page']) ?></title>
...
<nav>
    <ul class="topnav" id="nav-menu">
        ...
        <li><a href="#" class="active-nav"><?php echo htmlspecialchars($translations['projects']); ?></a></li>
...
<script>
    ...
    window.onload = function() {
        ...
        let projectsFile = 'src/content/projects-<?php echo htmlspecialchars($lang)?>.json';
