...
<main>
  <section class="projects-section py-5 bg-light">
    <div class="container">
      <h2 class="section-title text-center mb-5" data-i18n="projects.page_title">Nasze projekty</h2>
   ...
   <div class="container">
  <h2 class="section-title text-center mb-5" data-i18n="projects.upcoming_title">Nadchodzące projekty</h2>
